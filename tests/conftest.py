...
from config.browser.browser_factory import make_firefox_driver, make_simple_firefox_driver
from config.login.login_helpers import do_login, close_token_banner
...
def tools_driver_module(request):
    ...
    if browser == "chrome":
        from config.browser.browser_factory import make_chrome_driver
